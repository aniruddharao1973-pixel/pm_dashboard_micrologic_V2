...
const CreateFolderModal = ({
  ...
  return createPortal(
    <div className="fixed inset-0 z-[9999] flex items-center justify-center p-3 sm:p-4">
      ...
      <div className="relative w-full max-w-lg transform transition-all max-h-[90vh] overflow-y-auto">
        <div className="relative bg-white rounded-xl sm:rounded-2xl shadow-2xl ring-1 ring-black/5 overflow-hidden">
          {/* Decorative gradient border */}
          <div className="absolute inset-x-0 top-0 h-0.5 sm:h-1 bg-gradient-to-r from-violet-500 via-indigo-500 to-blue-500" />
          ...
          <div className="p-4 sm:p-6 md:p-8">
            ...
            <div className="flex items-start justify-between mb-4 sm:mb-6 md:mb-8">
              <div className="flex items-center space-x-2 sm:space-x-3 md:space-x-4">
                <div className="relative flex-shrink-0">
                  <div className="absolute inset-0 bg-gradient-to-br from-indigo-400 to-violet-600 rounded-lg sm:rounded-xl blur-lg opacity-75" />
                  <div className="relative flex items-center justify-center w-10 h-10 sm:w-11 sm:h-11 md:w-12 md:h-12 bg-gradient-to-br from-indigo-500 to-violet-600 rounded-lg sm:rounded-xl shadow-lg">
                    <FolderPlus
                ...
                <div className="min-w-0">
                  <h2 className="text-lg sm:text-xl md:text-2xl font-bold text-gray-900 tracking-tight truncate">
                    {isSubfolder ? "New Sub-folder" : "New Folder"}
                  </h2>
              ...
              <button
                onClick={onClose}
                className="group relative p-1.5 sm:p-2 text-gray-400 hover:text-gray-600 transition-all duration-200 flex-shrink-0"
              >
                <div className="absolute inset-0 bg-gray-100 rounded-lg opacity-0 group-hover:opacity-100 transition-opacity" />
                <X
            ...
            <div className="space-y-4 sm:space-y-6 md:space-y-8">
              ...
              <div className="space-y-1.5 sm:space-y-2">
                ...
                <div className="relative">
                  <div className="absolute inset-y-0 left-0 pl-3 sm:pl-4 flex items-center pointer-events-none">
                    <FolderPlus className="h-4 w-4 sm:h-5 sm:w-5 text-gray-400" />
                  </div>
                  <input
                    value={name}
                    onChange={(e) => setName(e.target.value)}
                    className="w-full pl-10 sm:pl-12 pr-3 sm:pr-4 py-2.5 sm:py-3 md:py-3.5 bg-gray-50 border border-gray-200 rounded-lg sm:rounded-xl text-gray-900 placeholder-gray-400
                      focus:bg-white focus:border-indigo-500 focus:ring-2 sm:focus:ring-4 focus:ring-indigo-500/10
              ...
              <div className="space-y-2 sm:space-y-3">
                ...
                <div className="grid gap-2 sm:gap-3">
                  <label
                    className={`relative flex items-start gap-3 sm:gap-4 p-3 sm:p-4 rounded-lg sm:rounded-xl border-2 cursor-pointer transition-all duration-200
                      ${
                        visibility === "customer"
                          ? "border-indigo-500 bg-gradient-to-r from-indigo-50 to-violet-50 shadow-sm"
                          : "border-gray-200 hover:border-gray-300 hover:bg-gray-50"
                  ...
                  >
                    ...
                    />
                    <div
                      className={`flex items-center justify-center w-8 h-8 sm:w-9 sm:h-9 md:w-10 md:h-10 rounded-lg flex-shrink-0 ${
                        visibility === "customer"
                          ? "bg-gradient-to-br from-indigo-500 to-violet-600 shadow-md"
                          : "bg-gray-100"
                      }`}
            ...
            {/* Footer */}
            <div className="flex items-center justify-end gap-2 sm:gap-3 mt-4 sm:mt-6 md:mt-8 pt-4 sm:pt-6 border-t border-gray-100">
              <button
                onClick={onClose}
                className="px-3 sm:px-4 md:px-5 py-2 sm:py-2.5 text-sm sm:text-base text-gray-700 font-medium bg-white border border-gray-300 rounded-lg sm:rounded-xl
                  hover:bg-gray-50 active:bg-gray-100 transition-all duration-200"
              >
                Cancel
              </button>
              ...
              <button
                onClick={handleSubmit}
                disabled={saving || !name.trim()}
                className="relative group px-4 sm:px-5 md:px-6 py-2 sm:py-2.5 bg-gradient-to-r from-indigo-500 to-violet-600 text-white font-medium rounded-lg sm:rounded-xl
                  shadow-lg shadow-indigo-500/25 hover:shadow-xl hover:shadow-indigo-500/30
                  disabled:from-gray-400 disabled:to-gray-500 disabled:shadow-none disabled:cursor-not-allowed
                  transition-all duration-200 transform hover:-translate-y-0.5 text-sm sm:text-base"
              >
