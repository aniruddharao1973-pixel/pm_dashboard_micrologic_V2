...
export default function CreateProjectModal({
  ...
  const handleCreate = async () => {
    ...
    try {
      setLoading(true);
      const res = await createProject({ name, customerId });
          ...
          <div className="px-8 pb-8 pt-10">
            ...
            <div className="flex items-center justify-end gap-3 mt-8 pt-6 border-t border-gray-100">
              ...
              <button
                ...
                className="relative group px-6 py-2.5 bg-gradient-to-r from-blue-500 to-indigo-600 text-white font-medium rounded-xl
