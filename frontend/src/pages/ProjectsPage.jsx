...
const ProjectsPage = () => {
  ...
  if (loading) {
    return (
      <div className="w-full min-h-screen bg-gradient-to-br from-slate-50 via-indigo-50/30 to-purple-50/40 flex items-center justify-center p-3 sm:p-4 lg:p-6">
  ...
  return (
    <div className="relative w-full min-h-screen">
      ...
      <div className="relative w-full">
        ...
        <div className="relative z-10 p-3 sm:p-4 md:p-6 lg:p-8 xl:p-12 max-w-7xl mx-auto">
          {/* Enhanced Header */}
          <div className="mb-4 sm:mb-6 md:mb-8 lg:mb-10 xl:mb-12">
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 sm:gap-4">
              <div className="space-y-2 sm:space-y-3">
                <div className="flex items-center gap-2 sm:gap-3">
                  <div className="w-1 sm:w-1.5 h-8 sm:h-10 lg:h-12 bg-gradient-to-b from-purple-500 to-indigo-600 rounded-full"></div>
                ...
                <p className="text-xs sm:text-sm md:text-base lg:text-lg text-gray-600 font-medium ml-3 sm:ml-4">
                  {user?.role === "department"
                    ? "Projects assigned to your department"
                    : user?.role === "customer"
                      ? "Projects under your organization"
              ...
              {/* Project count badge */}
              {projects.length > 0 && (
                <div className="self-start sm:self-auto flex items-center gap-1.5 sm:gap-2 px-3 sm:px-4 py-1.5 sm:py-2 bg-white/80 backdrop-blur-sm rounded-xl sm:rounded-2xl shadow-md sm:shadow-lg border border-gray-200/50">
                  <div className="w-1.5 h-1.5 sm:w-2 sm:h-2 bg-gradient-to-r from-green-400 to-emerald-500 rounded-full animate-pulse"></div>
                  <span className="text-[11px] sm:text-xs lg:text-sm font-semibold text-gray-700">
                    {projects.length} Active
                  </span>
                </div>
              )}
            ...
            {/* Decorative line */}
            <div className="mt-3 sm:mt-4 lg:mt-6 h-px bg-gradient-to-r from-transparent via-gray-300 to-transparent"></div>
          </div>
